...
def Frenet_to_cylindrical_residual_func(phi0, phi_target, qsc : Results, X_spline, Y_spline, Z_spline):
    """
...
def Frenet_to_cylindrical(results: Results, r, ntheta=20): # changed to use results class -> to_vmec will no longer work
    ...
    for j_theta in range(ntheta):
        ...
        X_at_this_theta = r * (results.complete_calculation_results.complete_r1_results.r1_results.X1c_untwisted * costheta + results.complete_calculation_results.complete_r1_results.r1_results.X1s_untwisted * sintheta)
        Y_at_this_theta = r * (results.complete_calculation_results.complete_r1_results.r1_results.Y1c_untwisted * costheta + results.complete_calculation_results.complete_r1_results.r1_results.Y1s_untwisted * sintheta)
